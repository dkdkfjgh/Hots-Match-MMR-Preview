...
namespace MatchPreviewApp
{
    class HotsMatchPreview
    {
        ...
        public string HotsMatchPreviewAnalyzer()
        {
            try
            {
            ...
            File.Delete(TemporaryBattlelobbyFileLocation);
    ...
    class HotsLogsParser
    {
        ...
        public void HotsLogsParse(string MatchURL)
        {
            HtmlAgilityPack.HtmlDocument Hdocument;
            HtmlWeb Hweb = new HtmlWeb();
            Hdocument = Hweb.Load(MatchURL);
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                if(Team == "0")
                {
                    BlueTeam.Add(new Player(NickName, PlayerID, TLTier, TLMMR, Team));
                }
                else
                {
                    RedTeam.Add(new Player(NickName, PlayerID, TLTier, TLMMR, Team));
                }
            }
    ...
    struct Player
    {
        ...
        public string TLTier;
        public string TLMMR;
        public string Team;
        public string ProfileURL;
        public string TierURL;
